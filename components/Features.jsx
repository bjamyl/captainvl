...
const Features = () => {
  return (
    <section className="bg-custom-gray px-4 pb-5 lg:rounded-bl-[280px] xl:rounded-bl-[450px]">
      <div className="space-y-[18px] lg:hidden">
        <MobileCard />
        <MobileCard />
        <MobileCard />
      </div>
      <div className="hidden lg:grid lg:grid-cols-6 gap-x-2 xl:grid-cols-8 xl:gap-x-4 ">
        ...
        <div className="pt-[48px] bg-white rounded-lg col-span-2 xl:col-span-3 pb-1 px-1">
          <div className="flex flex-col items-center justify-between h-full">
            <div className="flex flex-col items-center">
              ...
              <h2 className="mt-[119px] font-medium text-3xl xl:text-[45px]">
                Auto Transport
              </h2>
              <p className="text-center mt-10 text-sm lg:w-[331px] xl:w-[500px] xl:text-lg text-gray-400 px-10">
                ...
                <br />
                Sit back, relax, and let us handle the logistics of your auto
                transport needs.
              </p>
            </div>
